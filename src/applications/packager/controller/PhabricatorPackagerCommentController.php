...
final class PhabricatorPackagerCommentController
  ...
  public function processRequest() {
    ...
    $view_uri = $this->getApplicationURI('/view/'.$packageObject->getID().'/');

    $xactions = array();
    $xactions[] = id(new PhabricatorPackagerTransaction())
