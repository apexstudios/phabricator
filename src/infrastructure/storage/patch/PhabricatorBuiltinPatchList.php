...
final class PhabricatorBuiltinPatchList extends PhabricatorSQLPatchList {
  ...
  public function getPatches() {
    return array(
      ...
      '20130325.packager.sql' => array(
        'type'    => 'sql',
        'name'    => $this->getPatchPath('20130325.packager.sql'),
      ),
      '20130325.packagerrequest.sql' => array(
        'type'    => 'sql',
        'name'    => $this->getPatchPath('20130325.packagerrequest.sql'),
      ),
      '20130328.packagerqxupdate.sql' => array(
        'type'    => 'sql',
        'name'    => $this->getPatchPath('20130328.packagerqxupdate.sql'),
      ),
